import LightweightCharts, { createChart } from 'lightweight-charts';

// const binanceBaseURL = 'wss://stream.binance.com:9443/ws/';

// const binanceWebSocket = (symbol, stream, interval) => {
//   if (interval) {
//     const url = binanceBaseURL + symbol + '@' + stream + '_' + interval;
//     return new WebSocket(url);
//   }
//   const url = binanceBaseURL + symbol + '@' + stream;
//   return new WebSocket(url);
// };

// const socket = binanceWebSocket('btcusdt', 'miniTicker');
